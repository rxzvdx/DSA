 ...
 */
package Lab12;
public interface HashTableInterface<K extends Comparable<? super K>,V> {
    ...
    //returns the value associated with searchKey in the HashTable 
    //or null if the serchKey is not in the HashTable 
